...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Future<List<dynamic>> futureTask() async {
    ...
    try {
      result =
          await quiz.getQuiz(topicId: widget.topicId, buildContext: context);
    } catch (ex) {}

    setState(() {
      quizResult = result[0]['questions'];
      quizId = result[0]['_id'];
    });
  ...
  successfulQuiz(QuizProvider quiz) {
                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      onTap: () {
                        ...
                        if (selected ==
                            quizResult[quiz.number]['resource']['correctAnswer']
                                [0]) {
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Failure',
                                        style:
                                            redTextStyle.copyWith(fontSize: 21),
                                      )
                                    ],
                                  ),
                                ),
            ...
            Column(
              children: [
                ...
                Container(
                  ...
                  child: GridView.builder(
                      itemCount:
                          quizData[quiz.number]['resource']['questions'].length,
                      physics: NeverScrollableScrollPhysics(),
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                ...
                Container(
                  ...
                  child: GridView.builder(
                      itemCount:
                          quizResult[quiz.number]['resource']['options'].length,
                      physics: NeverScrollableScrollPhysics(),
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        crossAxisCount: 3,
                        childAspectRatio: 1.6,
